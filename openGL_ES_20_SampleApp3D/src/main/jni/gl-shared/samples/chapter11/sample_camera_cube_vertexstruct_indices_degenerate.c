...
typedef struct {
    ...
    // 回転角
    GLfloat rotate;
} Extension_CameraCubeVertexstructIndicesDegenerate;

/**
 * アプリの初期化を行う
 */
void sample_CameraCubeVertexstructIndicesDegenerate_initialize(GLApplication *app) {
    // サンプルアプリ用のメモリを確保する
    app->extension = (Extension_CameraCubeVertexstructIndicesDegenerate*) malloc(sizeof(Extension_CameraCubeVertexstructIndicesDegenerate));
    // サンプルアプリ用データを取り出す
    Extension_CameraCubeVertexstructIndicesDegenerate *extension = (Extension_CameraCubeVertexstructIndicesDegenerate*) app->extension;
 ...
 * レンダリングエリアが変更された
 */
void sample_CameraCubeVertexstructIndicesDegenerate_resized(GLApplication *app) {
    // 描画領域を設定する
 ...
 * 毎秒60回前後呼び出される。
 */
void sample_CameraCubeVertexstructIndicesDegenerate_rendering(GLApplication *app) {
    // サンプルアプリ用データを取り出す
    Extension_CameraCubeVertexstructIndicesDegenerate *extension = (Extension_CameraCubeVertexstructIndicesDegenerate*) app->extension;
 ...
 * アプリのデータ削除を行う
 */
void sample_CameraCubeVertexstructIndicesDegenerate_destroy(GLApplication *app) {
// サンプルアプリ用データを取り出す
    Extension_CameraCubeVertexstructIndicesDegenerate *extension = (Extension_CameraCubeVertexstructIndicesDegenerate*) app->extension;
