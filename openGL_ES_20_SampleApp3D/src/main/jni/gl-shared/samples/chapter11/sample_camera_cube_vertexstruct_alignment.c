...
typedef struct {
    ...
    // 回転角
    GLfloat rotate;
} Extension_CameraCubeVertexstructAlignment;

/**
 * アプリの初期化を行う
 */
void sample_CameraCubeVertexstructAlignment_initialize(GLApplication *app) {
    // サンプルアプリ用のメモリを確保する
    app->extension = (Extension_CameraCubeVertexstructAlignment*) malloc(sizeof(Extension_CameraCubeVertexstructAlignment));
    // サンプルアプリ用データを取り出す
    Extension_CameraCubeVertexstructAlignment *extension = (Extension_CameraCubeVertexstructAlignment*) app->extension;
 ...
 * レンダリングエリアが変更された
 */
void sample_CameraCubeVertexstructAlignment_resized(GLApplication *app) {
    // 描画領域を設定する
 ...
 * 毎秒60回前後呼び出される。
 */
void sample_CameraCubeVertexstructAlignment_rendering(GLApplication *app) {
    // サンプルアプリ用データを取り出す
    Extension_CameraCubeVertexstructAlignment *extension = (Extension_CameraCubeVertexstructAlignment*) app->extension;
 ...
 * アプリのデータ削除を行う
 */
void sample_CameraCubeVertexstructAlignment_destroy(GLApplication *app) {
// サンプルアプリ用データを取り出す
    Extension_CameraCubeVertexstructAlignment *extension = (Extension_CameraCubeVertexstructAlignment*) app->extension;
