...
//        // storyList_1のストーリー数をカウンター変数に入れる
//
//        // フラグを立てていないときのみ処理を実行する
//        if (!storyList_1EndedFlag) {
//            // storyList_1のストーリーサイズを設定する
//            setterMaxStoryCounter(storyList_1.size());
//            // 対象のストーリが終了（オーバー）していないか判定（storyList_1）
//            if (this.MaxStoryCounter > this.number) {
//                // ストーリー内容を取得
//                return this.storyList_1.get(this.number);
//
//                // 1つのストーリーが完了するたびにカウンタークリアと対象のstoryListサイズをセット（初回だけ）
//                // フラグを立てて、2度と入らないように変更する
//                // ストーリーインデクスもこのタイミングで初期化する
//            } else {
//                clearAllStoryCounter();
//                setterMaxStoryCounter(storyList_2.size());
//                storyList_1EndedFlag = true;
//                this.number = 0;
//            }
//        // フラグを立てていないときのみ処理を実行する
//        } else if (!storyList_2EndedFlag) {
//            // storyList_2のストーリーサイズを設定する
//            setterMaxStoryCounter(storyList_2.size());
//            // 対象のストーリが終了（オーバー）していないか判定（storyList_1）
//            if (this.MaxStoryCounter > this.number) {
//                // ストーリー内容を取得
//                return this.storyList_2.get(this.number);
//
//                // 1つのストーリーが完了するたびにカウンタークリアと対象のstoryListサイズをセット（初回だけ）
//                // フラグを立てて、2度と入らないように変更する
//                // ストーリーインデクスもこのタイミングで初期化する
//            } else {
//                clearAllStoryCounter();
//                setterMaxStoryCounter(storyList_3.size());
//                storyList_2EndedFlag = true;
//                this.number = 0;
//            }
//            // フラグを立てていないときのみ処理を実行する
//        } else if (!storyList_3EndedFlag) {
//            // storyList_2のストーリーサイズを設定する
//            setterMaxStoryCounter(storyList_3.size());
//            // 対象のストーリが終了（オーバー）していないか判定（storyList_1）
//            if (this.MaxStoryCounter > this.number) {
//                // ストーリー内容を取得
//                return this.storyList_3.get(this.number);
//
//                // 1つのストーリーが完了するたびにカウンタークリアと対象のstoryListサイズをセット（初回だけ）
//                // フラグを立てて、2度と入らないように変更する
//                // ストーリーインデクスもこのタイミングで初期化する
//            } else {
//                clearAllStoryCounter();
//                setterMaxStoryCounter(storyList_4.size());
//                storyList_3EndedFlag = true;
//                this.number = 0;
//            }
//        }
...
//            if (this.MaxStoryCounter > this.number) {
//                // ストーリー内容を取得
//                return this.storyList_1.get(this.number - 1);
//
//                // 1つのストーリーが完了するたびにカウンタークリアと対象のstoryListサイズをセット（初回だけ）
//                // フラグを立てて、2度と入らないように変更する
//                // ストーリーインデクスもこのタイミングで初期化する
...
//            if (this.MaxStoryCounter > this.number) {
//                // ストーリー内容を取得
//                return this.storyList_2.get(this.number - 1);
//
//                // 1つのストーリーが完了するたびにカウンタークリアと対象のstoryListサイズをセット（初回だけ）
//                // フラグを立てて、2度と入らないように変更する
//                // ストーリーインデクスもこのタイミングで初期化する
...
//            }
//        } else if (!storyList_3EndedFlag) {
//            // storyList_3のストーリーサイズを設定する
//            setterMaxStoryCounter(storyList_3.size());
//            // 対象のストーリが終了（オーバー）していないか判定（storyList_1）
//            if (this.MaxStoryCounter > this.number) {
//                // ストーリー内容を取得
//                return this.storyList_3.get(this.number - 1);
//
//                // 1つのストーリーが完了するたびにカウンタークリアと対象のstoryListサイズをセット（初回だけ）
//                // フラグを立てて、2度と入らないように変更する
//                // ストーリーインデクスもこのタイミングで初期化する
